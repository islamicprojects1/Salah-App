...
/// - "I Prayed" → logs the prayer
/// - "I Missed" → dismisses (user acknowledges)
/// - "Log All" → batch log all shown prayers
class QadaReviewBottomSheet extends StatefulWidget {
  const QadaReviewBottomSheet({super.key});

  /// Show the bottom sheet — call this from DashboardController or a button.
...
class _QadaReviewBottomSheetState extends State<QadaReviewBottomSheet> {
  final QadaDetectionService _qadaService = Get.find<QadaDetectionService>();
        ...
        children: [
          ...
          Flexible(
            child: Obx(() {
              ...
              if (items.isEmpty) {
                // All handled — close after a moment
              ...
              child: Padding(
                ...
                child: SizedBox(
                  ...
                  child: FilledButton.icon(
                    onPressed: _isLogging.value ? null : () => _logAll(remaining),
