...
class _FamilyFlameWidgetState extends State<FamilyFlameWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      final avgProgress = family.members.isNotEmpty
          ? totalLogged / family.members.length
          : 0.0;
      ...
      return AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final scale = 1.0 + (_flickerController.value * flickerIntensity);
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: flameColor.withValues(alpha: 0.2)),
              boxShadow: [
                BoxShadow(
              ...
              children: [
                Transform.scale(
                  ...
                  child: Transform.rotate(
                    angle: rotation,
                    child: Text('🔥', style: TextStyle(fontSize: flameSize)),
                  ),
                ),
